...
export const BrainstormView = (props: {
	...
	const { container, services, userDisplayName } = props;
	...
	return (
		<div className={wrapperClass}>
			<Header model={model} author={authorInfo} setShowCanvas={setShowCanvas}  showCanvas={showCanvas} members={members} userDisplayName={userDisplayName}/>
			<DndProvider backend={HTML5Backend}>
				<NoteSpace model={model} showCanvas={showCanvas} author={authorInfo}/>
			</DndProvider>
		</div>
	);
};
